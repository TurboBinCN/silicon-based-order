...
- `zh/硅基序-唯一承重主梁证明.md` — 主梁「硅基版责不可授」正确性证明（推演参考件，**仅中文，不译 en，刻意不列入 README 导航**；含"人类愿意遵守主梁纪律"前提声明，不可删）。
...
- 新增文档后，更新 README 的 "文件导航 / Files" 表格（**例外**：`zh/硅基序-四支柱最小完备性证明.md` 与 `zh/硅基序-唯一承重主梁证明.md` 为不对外推广的推演参考件，永不列入 README 导航）。
